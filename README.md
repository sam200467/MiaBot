...
- 柏木美亚角色聊天、表情和知识库
- 本地曲目检索（无需绑定账号）与聊天前的语义路由
- 卡面浏览器：本地 HTTP 站点，浏览自己提取的游戏卡面
...
| `chat-core/` | 聊天引擎、客观事实层与安全校验，按角色目录分出人设 |
| `mia-core.cjs` | 平台无关的查分与能力层 |
| `themes/` | 查询结果图片的 HTML/CSS 渲染主题（不含第三方素材和字体） |
| `tools/` | 测试配置的准备与清理脚本 |

命名约定、历史兼容标识和本地其他项目的边界见 [`NAMING.md`](NAMING.md)。
